...
import type { IconName, ProfileFormValues } from "../../../../shared/types/domain";

const SCROLL_INSET_OFFSET = Spacing.xxl + Spacing.xl + Spacing.xs;
const MIN_SCROLL_BOTTOM = Spacing.xxl * 2 + Spacing.base;
const HEADER_INSET_TOP_OFFSET = Spacing.sm;
const MIN_HEADER_TOP = Spacing.xl;
        ...
        <View style={styles.modalOverlay}>
          <View style={[styles.calendarModalContent, { backgroundColor: "#FFFFFF" }]}>
              ...
              {Array.from({
                ...
                return (
                  <TouchableOpacity
                    ...
                    style={[
                      styles.dayCell,
                      isSelected && { backgroundColor: "#083B75" },
                    ]}
                  >
                    <Text
                      style={[
            ...
            <View style={styles.modalButtonsRow}>
              ...
              >
                <Text style={[styles.modalCancelText, { color: "#0F172A" }]}>
                  Cancel
                </Text>
              </TouchableOpacity>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.customerTypeModalContent}>
            <View style={styles.calendarHeader}>
              ...
              <TouchableOpacity onPress={() => setShowCustomerTypeModal(false)}>
                <Ionicons name="close" size={22} color="#64748B" />
              </TouchableOpacity>
            </View>
