...
export { GSTDocuments } from './GSTDocuments/GSTDocuments'
export { GSTPaymentsTab } from './GSTPaymentsTab/GSTPaymentsTab'
export { GSTServices } from './GSTServices/GSTServices'
export { GSTStats } from './GSTStats/GSTStats'
export { GSTTimelineTab } from './GSTTimelineTab/GSTTimelineTab'

// Registration Components (Original structure)
